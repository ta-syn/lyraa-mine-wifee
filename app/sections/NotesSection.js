  ...
  return (
    <section className="notes-s" id="notes">
      ...
      <div className="notes-grid">
        ...
        <div className="note rv">
          <span className="note-ico">🌙</span>
          <h3 className="note-title">On the nights you can&apos;t sleep</h3>
          <p className="note-body">
            I am always with you — not only beside you, but in every quiet way love stays. Think of me and know you are <strong>never alone</strong>, not even for one heartbeat.
          </p>
          <span className="note-tag">From Yuki</span>
        </div>
        <div className="note rv">
          ...
          <span className="note-tag">Always</span>
        </div>
        <div className="note rv">
          <span className="note-ico">💫</span>
