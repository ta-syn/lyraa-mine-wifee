    ...
    <section className="reasons-s rv" id="reasons">
      ...
      <div className="reasons-grid">
        ...
        <div className="rcard">
          ...
          <span className="rcard-emoji">🧠</span>
          <h3 className="rcard-title">Your beautiful mind</h3>
          <p className="rcard-body">The way you think, the way you understand people, the way you feel deeply — you amaze me endlessly. Loving you means discovering new wonder every day.</p>
        </div>
        <div className="rcard">
          <div className="rcard-num">04</div>
          <span className="rcard-emoji">🤍</span>
          <h3 className="rcard-title">Your kindness</h3>
          <p className="rcard-body">You carry softness even in hard moments. Your kindness heals more than you know, and it makes me want to become a better man every day.</p>
        </div>
        <div className="rcard">
          <div className="rcard-num">05</div>
          <span className="rcard-emoji">🌸</span>
          <h3 className="rcard-title">The little things</h3>
          <p className="rcard-body">Your tiny habits, your expressions, your little moods — all those details that are uniquely yours. They are small to the world, but everything to me.</p>
        </div>
        <div className="rcard">
